...
function SideBar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`lg:w-[20%] w-[200px] lg:bg-transparent lg:h-[100vh] h-[80vh] lg:p-8 px-1 py-2 overflow-y-auto flex-col justify-center border lg:flex lg:static absolute z-[1000] bg-zinc-900 top-[4.4rem] ${
